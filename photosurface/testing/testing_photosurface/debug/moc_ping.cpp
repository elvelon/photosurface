...
QT_MOC_LITERAL(1, 5, 9), // "logToFile"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 6), // "onPing"
QT_MOC_LITERAL(4, 23, 13), // "deletePicList"
QT_MOC_LITERAL(5, 37, 16), // "dl_replyFinished"
QT_MOC_LITERAL(6, 54, 14), // "QNetworkReply*"
QT_MOC_LITERAL(7, 69, 5) // "reply"

    },
    "Ping\0logToFile\0\0onPing\0deletePicList\0"
    "dl_replyFinished\0QNetworkReply*\0reply"
};
...
void Ping::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->logToFile((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->onPing(); break;
        case 2: _t->deletePicList(); break;
        case 3: _t->dl_replyFinished((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Ping::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Ping::logToFile)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Ping::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Ping.data,
      qt_meta_data_Ping,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void Ping::logToFile(QString _t1)
{
